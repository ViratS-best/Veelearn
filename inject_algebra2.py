...
from algebra2_curriculum import all_units, build_master

GRADE = 10
MASTER_TITLE = "Algebra 2 Complete"
RNG_SEED = 20260802
...
def upsert_master(cursor, creator_id):
    desc = (
        "Deep grade-10 Algebra 2 master course: eight units with long explanations, "
