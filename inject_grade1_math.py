...
from grade1_math_curriculum import all_units, build_master
...
def upsert_master(cursor, creator_id):
    desc = (
        "First-grade math master course: counting to 120, tens and ones, addition and "
        "subtraction to 20, number stories, time, measuring length, and shapes. "
