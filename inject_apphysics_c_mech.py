...
from apphysics_c_mech_curriculum import all_units, build_master

GRADE = 12
MASTER_TITLE = 'AP Physics C Mechanics Complete'
RNG_SEED = 20260833
...
def upsert_master(cursor, creator_id):
    desc = (
        "Deep AP Physics C: Mechanics master course: eight units with long explanations, "
