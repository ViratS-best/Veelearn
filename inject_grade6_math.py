#!/usr/bin/env python3
"""Inject Sixth Grade Math master + 8 units into Aiven.
...
from grade6_math_curriculum import all_units, build_master

GRADE = 6
MASTER_TITLE = "Sixth Grade Math"
RNG_SEED = 20260818
EXPECTED_Q = 80
...
def upsert_master(cursor, creator_id):
    desc = (
        "Sixth-grade math master course: ratios and rates, percents, rational numbers "
        "(including dividing fractions), integers, the four-quadrant coordinate plane, "
        "expressions and equations, area/surface area/volume, and data analysis. "
