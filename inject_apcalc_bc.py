...
from apcalc_bc_curriculum import all_units, build_master

GRADE = 12
MASTER_TITLE = 'AP Calculus BC Complete'
RNG_SEED = 20260826
...
def upsert_master(cursor, creator_id):
    desc = (
        "Deep AP Calculus BC master course: eight units with long explanations, "
