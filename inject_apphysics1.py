...
from apphysics1_curriculum import all_units, build_master

GRADE = 11
MASTER_TITLE = 'AP Physics Complete'
RNG_SEED = 20260832
...
def upsert_master(cursor, creator_id):
    desc = (
        "Deep AP Physics 1 master course: eight units with long explanations, "
