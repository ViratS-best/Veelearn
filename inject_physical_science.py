...
from physical_science_curriculum import all_units, build_master

GRADE = 9
MASTER_TITLE = 'Physical Science Complete'
RNG_SEED = 20260835
...
def upsert_master(cursor, creator_id):
    desc = (
        "Deep High school Physical Science master course: eight units with long explanations, "
