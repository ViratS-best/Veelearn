#!/usr/bin/env python3
"""Inject Second Grade Math master + 8 units into Aiven.
...
from grade2_math_curriculum import all_units, build_master

GRADE = 2
MASTER_TITLE = "Second Grade Math"
RNG_SEED = 20260815
EXPECTED_Q = 80
...
def upsert_master(cursor, creator_id):
    desc = (
        "Second-grade math master course: numbers to 1,000, addition and subtraction "
        "with regrouping, two-step word problems, time to five minutes, counting money, "
        "geometry, and fractions. Short words, quizzes after every idea, and 50 practice problems per unit."
    )
