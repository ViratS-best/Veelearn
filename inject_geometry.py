...
from geometry_curriculum import all_units, build_master

GRADE = 10
MASTER_TITLE = 'Geometry Complete'
RNG_SEED = 20260822
...
def upsert_master(cursor, creator_id):
    desc = (
        "Deep High school Geometry master course: eight units with long explanations, "
