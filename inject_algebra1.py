...
from algebra1_curriculum import all_units, build_master

GRADE = 9
MASTER_TITLE = 'Algebra 1 Complete'
RNG_SEED = 20260821
...
def upsert_master(cursor, creator_id):
    desc = (
        "Deep Grade 9 Algebra 1 master course: eight units with long explanations, "
