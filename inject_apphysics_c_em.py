...
from apphysics_c_em_curriculum import all_units, build_master

GRADE = 12
MASTER_TITLE = 'AP Physics C E&M Complete'
RNG_SEED = 20260834
...
def upsert_master(cursor, creator_id):
    desc = (
        "Deep AP Physics C: Electricity and Magnetism master course: eight units with long explanations, "
