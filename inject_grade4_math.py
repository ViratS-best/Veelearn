#!/usr/bin/env python3
"""Inject Fourth Grade Math master + 8 units into Aiven.
...
from grade4_math_curriculum import all_units, build_master

GRADE = 4
MASTER_TITLE = "Fourth Grade Math"
RNG_SEED = 20260816
EXPECTED_Q = 80
...
def upsert_master(cursor, creator_id):
    desc = (
        "Fourth-grade math master course: place value to one million, multi-digit "
        "multiply and divide, add and subtract fractions with like denominators, "
        "decimals as tenths and hundredths, geometry, and measuring angles with a protractor. "
