...
from apcalc_ab_curriculum import all_units, build_master

GRADE = 12
MASTER_TITLE = 'AP Calculus AB Complete'
RNG_SEED = 20260825
...
def upsert_master(cursor, creator_id):
    desc = (
        "Deep AP Calculus AB master course: eight units with long explanations, "
