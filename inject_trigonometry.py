...
from trigonometry_curriculum import all_units, build_master

GRADE = 11
MASTER_TITLE = 'Trigonometry Complete'
RNG_SEED = 20260823
...
def upsert_master(cursor, creator_id):
    desc = (
        "Deep High school Trigonometry master course: eight units with long explanations, "
