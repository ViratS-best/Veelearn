...
from precalculus_curriculum import all_units, build_master

GRADE = 11
MASTER_TITLE = 'Precalculus Complete'
RNG_SEED = 20260824
...
def upsert_master(cursor, creator_id):
    desc = (
        "Deep High school Precalculus master course: eight units with long explanations, "
