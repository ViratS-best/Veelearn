#!/usr/bin/env python3
"""Inject Eighth Grade Math master + 8 units into Aiven.
...
from grade8_math_curriculum import all_units, build_master

GRADE = 8
MASTER_TITLE = "Eighth Grade Math"
RNG_SEED = 20260820
EXPECTED_Q = 55
...
def upsert_master(cursor, creator_id):
    desc = (
        "Eighth-grade math master course: exponents and scientific notation, linear "
        "equations, functions and slope, complex two-variable systems, the Pythagorean "
        "theorem, and statistical data. Pre-algebra for high school. "
