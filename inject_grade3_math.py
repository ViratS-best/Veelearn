#!/usr/bin/env python3
"""Inject Third Grade Math master + 8 units into Aiven.
...
from grade3_math_curriculum import all_units, build_master

GRADE = 3
MASTER_TITLE = "Third Grade Math"
RNG_SEED = 20260816
EXPECTED_Q = 80
...
def upsert_master(cursor, creator_id):
    desc = (
        "Third-grade math master course: multi-digit numbers, multiplication and "
        "division within 100, multi-step word problems, fractions, area, and perimeter. "
